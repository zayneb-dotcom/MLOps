"""
Random Forest model training with MLflow tracking
Alternative model for comparison with XGBoost
"""
import argparse
import pandas as pd
import numpy as np
...
def train_random_forest(
    input_path: str,
    model_path: str,
    experiment_name: str = "fraud_detection_rf",
    use_smote: bool = True,
    test_size: float = 0.2
):
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str, default="models/random_forest_fraud_model.pkl", 
                        help="Model save path")
    parser.add_argument("--experiment", type=str, default="fraud_detection_rf", 
